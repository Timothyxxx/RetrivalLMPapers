...
8. **Adaptive Semiparametric Language Models.** TACL.
   
   *Dani Yogatama, Cyprien de Masson d'Autume, Lingpeng Kong*  [[pdf](https://arxiv.org/abs/2102.02557)], 2021.02

9. **NLP From Scratch Without Large-Scale Pretraining: A Simple and Efficient Framework.** Preprint.
...
10. **End-to-End Training of Multi-Document Reader and Retriever for Open-Domain Question Answering.** NIPS.
...
11. **Improving language models by retrieving from trillions of tokens.** Preprint.
...
12. **Learning To Retrieve Prompts for In-Context Learning.** Preprint.
...
13. **LaMDA: Language Models for Dialog Applications.** Preprint.
