...
5. **Adaptive Semiparametric Language Models.** TACL.
   
   *Dani Yogatama, Cyprien de Masson d'Autume, Lingpeng Kong*  [[pdf](https://arxiv.org/abs/2102.02557)], 2021.02

6. **NLP From Scratch Without Large-Scale Pretraining: A Simple and Efficient Framework.** Preprint.
...
7. **Improving language models by retrieving from trillions of tokens.** Preprint.
...
8. **Learning To Retrieve Prompts for In-Context Learning.** Preprint.
...
9. **LaMDA: Language Models for Dialog Applications.** Preprint.
